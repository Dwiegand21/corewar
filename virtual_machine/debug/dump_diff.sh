...
echo "$( diff <( ./$ORIGIN_EXE -d $1  ./champs_bins/C248.cor champs_bins/O-Maley_Miaou.cor | grep '0x' ) <( ./$OUR_EXE -d $1  ./champs_bins/C248.cor champs_bins/O-Maley_Miaou.cor  | grep '0x' ) )"