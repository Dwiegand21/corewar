...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/02 21:20:01 by dwiegand          #+#    #+#             */
/*   Updated: 2019/06/02 21:20:01 by dwiegand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "virtual_machine.h"

void		or_method1(t_area *area, t_process *process) // first is REG
{
	int32_t		shift;
...
void		or_method2(t_area *area, t_process *process) // first is DIR
{
	int32_t		shift;
...
void		or_method3(t_area *area, t_process *process) // first is IND
{
	int32_t		shift;
